...
export default function NuevoEvento() {
  ...
  >
    <ScrollView style={styles.container} contentContainerStyle={styles.contenido}>
      ...
      <TextInput style={styles.input} placeholder="Ej: Plaza Mayor" placeholderTextColor="#aaa" value={lugar} onChangeText={setLugar} />
...
const styles = StyleSheet.create({
  ...
  boton: { backgroundColor: '#1A5276', borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 8 },
